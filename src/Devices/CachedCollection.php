...
class CachedCollection extends Collection
{
    ...
    /**
     * @var DeviceCollectionInterface $collection The device collection to actually use.
     */
    private $collection;
     ...
     *
     * @param DeviceCollectionInterface $collection The device collection to actually use
     ...
     */
    public function __construct(DeviceCollectionInterface $collection, CacheInterface $cache)
    {
